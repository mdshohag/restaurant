...
<META NAME="Restaurent" CONTENT="Restaurent">
<!--    favicon Icon set-->
...
<!--                    <li> <a href="http://localhost/phpmyadmin/#PMAURL-12:db_export.php?db=db_shop_fixed&table=&server=1&target=&token=871f8b9d7e7f52cc63f42b7e8b760604" target="_blank"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Database Backup</b> </a> </li>-->
          ...
          <!--employee-->
            ...
            if($user_type != "waiter")
            {
                ?>
          <!--employee end-->
          <li> <a href="javascript:void(0);"> <i class="fa fa-tasks"></i>FOOD CATEGORY <span class="plus"><i class="fa fa-plus"></i></span></a>
            <ul>
          ...
          <li> <a href="javascript:void(0);"> <i class="fa fa-tasks"></i> FOOD MENUS <span class="plus"><i class="fa fa-plus"></i></span></a>
            <ul>
              <li> <a href="foodMenuAdd"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Add  Menu</b> </a> </li>
              <li> <a href="foodMenuManage"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Manage  Menu</b> </a> </li>
			  <li> <a href="foodMenuPrice"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b> Menu Pricing</b> </a> </li>
...
<!--			   <li> <a href="itemDamageRecovery"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Recover Damage</b> </a> </li>-->
                ...
                <li> <a href="javascript:void(0);"> <i class="fa fa-tasks"></i> TABLES <span class="plus"><i class="fa fa-plus"></i></span></a>
                    <ul>
                        <li> <a href="tableAdd"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Add Table</b> </a> </li>
                        <li> <a href="tableManage"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Manage Table</b> </a> </li>
                    </ul>
                </li>
                <li> <a href="javascript:void(0);"> <i class="fa fa-tasks"></i> WAITER <span class="plus"><i class="fa fa-plus"></i></span></a>
                    <ul>
                        <li> <a href="waiteradd"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Add Waiter</b> </a> </li>
                        <li> <a href="waitermanage"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Manage Waiter</b> </a> </li>
                    </ul>
                </li>

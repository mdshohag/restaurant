                ...
                <div class="login_content">
                    ...
                    <form method="post" action="" class="form-horizontal" id="login">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" placeholder="Username or Email" name="username" class="form-control" value="admin">
                            </div>
                        </div>
                        <div class="form-group">

                            <div class="col-sm-10">
                                <input type="password" id="password" placeholder="Password" name="password" class="form-control" value="admin">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class=" col-sm-10">

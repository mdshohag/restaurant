                  ...
                  <tbody>
                   <?php
                    ...
                    $item = $rep_row['item_id'];
                        ...
                        $g_total = $g_total + $rep_row['g_total'];
                   ?>
                    <tr class="gradeC">
                      <td align="center"><?php if($sl < 10) { echo '0';} echo $sl++; ?></td>
                      <td class="center"><?php echo date('d-m-Y',strtotime($rep_row['sales_date'])); ?></td>
                      <td class="center"><?php echo $invoice_id; ?></td>
                      <td align="right"><?php echo number_format($rep_row['sub_total'], 2, '.', ','); ?></td>
                      <td align="right"><?php echo $rep_row['due']; ?></td>
...
<?php
        ...
        <!--invoice report-->
        <div class="row" id="sales_print_" style="display: none">
...
//                                    print_r($rep_row);
                                ...
                                $g_total = $g_total + $rep_row2['g_total'];
                                ?>
                                    <tr class="gradeC">
                                        <td class="center" style="font-size:12px;"><?php  echo $sl++; ?></td>
                                        <td class="center" style="font-size:12px;"><?php echo date('d-m-y'),strtotime($rep_row2['sales_date']); ?></td>
                                        <td class="center" style="font-size:12px;"><?php echo $invoice_id; ?></td>
                                        <td class="center" style="font-size:12px;"><?php echo number_format($rep_row2['sub_total'], 2, '.', ','); ?></td>
                                        <td class="center" style="font-size:12px;"><?php echo $rep_row2['due']; ?></td>

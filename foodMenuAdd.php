    ...
    <div class="contentpanel">
      ...
      <div class="pull-left breadcrumb_admin clear_both">
        <div class="pull-left page_title theme_color">
          <h1>Food Menus</h1>
          <h2 class="">Food Menu Add Form</h2>
        </div>
        <div class="pull-right">
          <ol class="breadcrumb">
            <li><a href="#">Home</a></li>
            <li><a href="#">Food Menu</a></li>
            <li class="active">Food Menu Add</li>
          </ol>
        </div>
      </div>
        ...
        <div class="col-md-6">
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">Add Food Menu </h3>
            </div>
            <div class="porlets-content">
               <form action=""  method="post" id="item_add" class="form-horizontal row-border" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="item_name" required placeholder="Menu Name">
                  </div>
                </div><!--/form-group-->
				 <div class="form-group">
                  <label class="col-sm-3 control-label">Menu Code</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="item_code"  placeholder="Menu Code" required>
                  </div>
                </div><!--/form-group-->
                   <div class="form-group">
                       <label class="col-sm-3 control-label">Menu Size</label>
                       <div class="col-sm-9">
            ...
            <div id="per_inner"></div>
                ...
                <div>
                  <input type="submit" name="item_add" value="Submit" class="btn btn-primary" value="Submit">
                    <a type="button" href="foodMenuManage" class="btn btn-default">Cancel</a>
                </div><!--/form-group-->
              </form>
            </div><!--/porlets-content-->
          </div><!--/block-web--> 

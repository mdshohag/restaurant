...
?>
            ...
            <input type="button" name="pur_report_print" id="btnPrint_invoice" class="btn btn-primary" value="Print">
        </div><!--/col-md-12--> 
      </div><!--/row-->
      ...
      <!--invoice print-->
              ...
              <div class="row">
                  <div class="col-md-3" style="!border:1px dashed #333;">
                      <div class="block-web" id="content1">
                          <div class="header">
    ...
    <script type="text/javascript">
        $("#btnPrint_invoice").on("click", function() {
            var params = [

...
<div class="contentpanel">
    ...
    <div class="pull-left breadcrumb_admin clear_both">
        <div class="pull-left page_title theme_color">
            <h1>WAITER</h1>
            <h2 class="">manage waiter</h2>
        </div>
        <div class="pull-right">
            <ol class="breadcrumb">
                <li><a href="#">Home</a></li>
                <li>Waiter</li>
                <li class="active">Waiter Manage</li>
            </ol>
        </div>
    </div>
                    ...
                    <div class="col-md-12">
                        <div class="block-web">
                            <div class="header">
                                ...
                                <h3 class="content-header">Waiter List</h3>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            while ($emp_row = $query->fetch_assoc()) {
                                                ...
                                                <tr class="gradeC">
                                                    ...
                                                    <td class="center hidden-phone"><a class="btn btn-primary" href="waiterEdit/employee/<?php echo $emp_row['id']; ?>">Edit</a></td>
                                                </tr>
                                                <?php
                                            }
                                            ?>
